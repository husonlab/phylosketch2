...
* If your new edge starts near a node, then the edge will attach to that node.
* If the edge starts near an existing edge, then a node will be inserted into the existing edge
